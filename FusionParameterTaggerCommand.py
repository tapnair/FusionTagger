...
class FusionParameterTaggerCommand(Fusion360CommandBase):
    ...
    def on_execute(self, command, inputs, args, input_values):
        ...
        for parameter in parameters:
            parameter.attributes.add(input_values['attribute_group'], input_values['attribute_name'], parameter.name)
    ...
    def on_create(self, command, command_inputs):
        ...
        command_inputs.addStringValueInput('attribute_name', 'Name', 'ATTR_Parameter')
